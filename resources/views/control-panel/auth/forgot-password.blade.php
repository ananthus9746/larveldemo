...
<body class="fix-header fix-sidebar forgot_password_page card-no-border">
            ...
            <div class="auth-box card">
                <div class="card-body auth-card-body">
                    ...
                    <?php if (session()->has('status')): ?>
                        ...
                        <?php endif; ?>
                    <?php endif ?>
                    <form action="<?= url('control-panel/forgot-password') ?>" class="floating-labels" id="forgot-password-form" method="post" autocomplete="off" accept-charset="utf-8">
                        
                        <h3 class="p-2 rounded-title font-weight-bold text-black-100 text-center mb-3">Forgot Password?</h3>
    ...
    <script class="after-script" src="{{ url('assets/js/control-panel/pages/auth/forgot-password.js') }}"></script>
