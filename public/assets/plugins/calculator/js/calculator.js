$(document).ready(function () {
    ...
    */
    ...
    $('#percentage').on('click', function () {
        ...
        $('.calculator-container #divide').click();
        $('.calculator-container #one').click();
        $('.calculator-container #zero').click();
        $('.calculator-container #zero').click();
        ...
        // if (display1.numOfPct < 1 && flag.pctAllowed) {
            ...
            //             console.log(display1.operation);
            //             console.log(display1.operator);
