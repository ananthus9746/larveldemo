	...
	<div class="row">
        ...
        <div class="col-md-12">
            <div class="card shadow">
                ...
                <div class="card-body">
                    <form class="floating-labels" action="<?= route('categories.store') ?>" method="post" autocomplete="off" id="create-category-form" novalidate>
                        <div class="row">
                ...
                <div class="card-body">
                    <div class="row floating-labels">
                        <div class="col-md-3 mb-md-0 mb-3">
                            <div class="form-group">
                                <label>Search</label>
                                <input type="text" class="form-control form-control-sm categoryTableSearchInput">
                                <span class="bar"></span>
                            </div>
                        </div>
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <select class="form-control form-control-sm categoryTableSearchBySelect">
                        ...
                        <div class="col-md-12">
                            <div class="table-responsive">
                                ...
                                <div class="categoryTablePagination za-margin-top noselect"></div>
                            </div>
                        </div>
                    </div>
				</div>
    ...
    <div class="modal fade" id="editModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" style="display: none;" aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <form action="<?= route('categories.update','?') ?>" class="floating-labels edit-form" method="put" autocomplete="off" id="edit-category-form">
    ...
    <div class="modal fade" id="delModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" style="display: none;" aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <form action="<?= route('categories.destroy','?') ?>" class="delete-form">
...
@section('script') 
	<script class="after-script" src="{{ url('assets/js/control-panel/pages/products/category.js') }}"></script>
@endsection